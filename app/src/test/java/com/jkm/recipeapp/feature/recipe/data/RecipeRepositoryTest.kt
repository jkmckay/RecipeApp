...
class RecipeRepositoryTest {
    ...
    @Test
    fun `flowOfRecipes fetches and maps recipes correctly`() = runTest {
        // Arrange
        val recipesDto = RecipeResponse(
            recipes = listOf(
    ...
    @Test
    fun `flowOfRecipes handles empty list`() = runTest {
        // Arrange
    ...
    @Test
    fun `flowOfRecipes filters out malformed data`() = runTest {
        // Arrange
        val recipesDto = RecipeResponse(
            recipes = listOf(
